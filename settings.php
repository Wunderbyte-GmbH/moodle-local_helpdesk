...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        ...
        // The help menu is cached as it was rendered, and most of these settings show in it.
        foreach ($settings->settings as $setting) {
            $setting->set_updatedcallback('local_helpdesk\\local\\supportmenu_cache::purge');
        }
    }
}
